...
export class NewAuthService {
  ...
  setSecurityQuestion(
    Question_securite: string,
    Reponse_securite: string
  ): Observable<any> {
    const body = {
      Question_securite,
      Reponse_securite,
    ...
    return this.http.post(`${this.apiUrl}/set-security`, body, {
      withCredentials: true,
    });
  }
  ...
  login(Email: string, hashedPassword: string): Observable<any> {
    ...
    return this.http
      .post(`${this.apiUrl}/login`, body, { withCredentials: true })
      .pipe(
        map((response) => {
  ...
  logout(): Observable<any> {
    return this.http
      .delete(`${this.apiUrl}/Deconnexion`, { withCredentials: true })
      .pipe(
        map((response) => {
  ...
  updateUserStatus(status: string): Observable<any> {
    const body = { status };
    return this.http.put(`${this.apiUrl}/set-status`, body, {
      withCredentials: true,
    });
  }
  ...
  updateSecurityQuestion(question: string, answer: string): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/update-security`, body, {
      withCredentials: true,
    });
  }
